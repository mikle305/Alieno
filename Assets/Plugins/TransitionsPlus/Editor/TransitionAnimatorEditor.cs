...
namespace TransitionsPlus {
    ...
    public class TransitionAnimatorEditor : UnityEditor.Editor {
        ...
        SerializedProperty canvas, defaultScreen;
        ...
        void OnEnable() {
            ...
            defaultScreen = serializedObject.FindProperty("defaultScreen");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(defaultScreen);
